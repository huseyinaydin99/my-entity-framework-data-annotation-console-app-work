...
using EFDataAnnotationConsoleApp.DAL.Contexts;

namespace EFDataAnnotationConsoleApp
{
    ...
    foreach (var customer in context.Customers)
    {
        ...
        {*/
            ...
            */
            ...
            {
                var customersList = NorthwindContext.Customers.ToList();
            ...
            Console.WriteLine("Kapatmak için herhangi bir tuşa basıverirsen eğer kapanır gider.");
            Console.ReadKey();
        }
    }
}
